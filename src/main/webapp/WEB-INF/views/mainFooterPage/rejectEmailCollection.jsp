...
<body>
        ...
        <div>
            <div style="width: 100%; text-align: center; font-size: 110%;">본 웹사이트에 게시된 이메일 주소가 전자우편 수집 프로그램이나 그 박의 기술적 장치를 이용하여<br>
            무단으로 수집되는 것을 거부하며 이를 위반시 <b>「정보통신망 이용촉진 및 정보보호 등에 관한 법률」</b>에 의해 형사처벌됨을 유념하시기 바랍니다.</div>
        </div>
