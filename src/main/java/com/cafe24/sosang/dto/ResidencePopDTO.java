...
public class ResidencePopDTO {
	...
	public int getFamily_total() {
		return family_total;
	}

	public void setFamily_total(int family_total) {
	...
	public String toString() {
		return "[family_total=" + family_total + ", total=" + total + ", total_male=" + total_male + ", total_female="
				+ total_female + ", total_10=" + total_10 + ", total_20=" + total_20 + ", total_30=" + total_30
				+ ", total_40=" + total_40 + ", total_50=" + total_50 + ", total_60=" + total_60 + "]";
	}
}
